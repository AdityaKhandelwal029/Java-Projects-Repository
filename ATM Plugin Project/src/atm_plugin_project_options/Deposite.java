...
public class Deposite extends TitleAreaDialog{
	...
	public Deposite(Shell parentShell,List<Employeedata> list) {
		super(parentShell);
		this.list=list;
	...
	protected Control createContents(Composite parent) {
		...
		setTitle("Deposite amount");
		setMessage("Deposite user amount", IMessageProvider.INFORMATION);
		return contents;
	}
	@Override
	...
	protected void okPressed(){
	     ...
	     while (iterator.hasNext())
	     {
				...
				{
					listdata.setBalance(listdata.getBalance()+newamount);			
					isvalidUser=true; 
					MessageDialog.openInformation(getParentShell(), "Info", "Transaction successfull amount deposited.");
					break;
				}
	     }
	...
	protected void createButtonsForButtonBar(Composite parent) {
		...
		createButton(parent, IDialogConstants.OK_ID, "Deposite", false);
		getButton(IDialogConstants.OK_ID).setEnabled(false);
