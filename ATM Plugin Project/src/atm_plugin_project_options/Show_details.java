...
public class Show_details extends TitleAreaDialog{

	private Text AccountNo;
	List<Employeedata> list;
		
	public Show_details(Shell parentShell,List<Employeedata> list) {
		super(parentShell);
		this.list=list;
	...
	protected Control createContents(Composite parent) {
		...
		setTitle("User info");
		setMessage("Show user details", IMessageProvider.INFORMATION);
		return contents;
	}
	@Override
	...
	protected void okPressed(){
	     ...
	     while (iterator.hasNext())
	     {
				...
				if(listdata.getAccountno().equals(userAccountnoInput))
				{
					String detail = ""; 
					detail=detail+listdata.getAccountno()+" "+listdata.getName()+" "+listdata.getAddress()+" "+listdata.getEmail()+" "+listdata.getMobile()+
							" "+listdata.getBalance();
					isvalidUser=true; 
					MessageDialog.openInformation(getParentShell(), "Info", detail);
					break;
				}
	     }
	...
	protected void createButtonsForButtonBar(Composite parent) {
		...
		createButton(parent, IDialogConstants.OK_ID, "Showdetails", false);
		getButton(IDialogConstants.OK_ID).setEnabled(false);
