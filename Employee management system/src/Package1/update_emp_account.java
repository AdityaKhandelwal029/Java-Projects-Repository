...
public class update_emp_account {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					update_emp_account window = new update_emp_account();
	...
	private void initialize() {
		...
		JLabel lblNewLabel_2_1_1_1_1 = new JLabel("Salary");
		lblNewLabel_2_1_1_1_1.setFont(new Font("Tahoma", Font.BOLD, 24));
		lblNewLabel_2_1_1_1_1.setBounds(525, 866, 85, 35);
		...
		textField_6.setBounds(747, 868, 350, 35);
		...
		btnNewButton_1_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try
				{
					...
					try {
						stmt=con.createStatement();							
						String query="update employeedata set name = '"+username1+"', address = '"+address+"', department = '"+department+"', salary = '"+salary+"' where id="+id_no;                                                           
		...
		btnNewButton_1_1_1.setBounds(714, 757, 200, 40);
